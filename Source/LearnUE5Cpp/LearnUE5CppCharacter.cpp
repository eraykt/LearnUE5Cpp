...
ALearnUE5CppCharacter::ALearnUE5CppCharacter()
{
...
void ALearnUE5CppCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ALearnUE5CppCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * TurnRateGamepad * GetWorld()->GetDeltaSeconds());
}

void ALearnUE5CppCharacter::MoveForward(float Value)
{
